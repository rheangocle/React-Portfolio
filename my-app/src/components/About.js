    ...
    <section id='about' className='px-20'>
      <div className='container mx-auto flex px-10 py-20 md:flex-row flex-col items-center'>
        <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-left'>
          <h1 className='font-semibold title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 '>
            Hi there, you can call me Rhea!
          </h1>
          <p className='mb-5'>
        ...
        <div className='sm:w-1/4 md:w-1/4 lg:w-1/5'>
          <img
